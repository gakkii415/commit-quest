...
VERSION_TARGETS = [["index.html","<!-- app-version:start -->v","<!-- app-version:end -->"],["pages/index.html","<!-- app-version:start -->v","<!-- app-version:end -->"]]
MIGRATION_BASE = '335aed5972ebb05c402cd5e3328b5cd9940fa63e'
MIGRATION_VERSION = 1
